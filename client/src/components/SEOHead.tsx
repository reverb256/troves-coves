...
export default function SEOHead({
  ...
  useEffect(() => {
      ...
      "@graph": [
        {
          ...
          "@id": `${url}/#business`,
          "name": "Troves & Coves",
          "description": "Premium crystal jewelry and healing stones in Winnipeg, Manitoba. Handcrafted necklaces, wire-wrapped pendants, and authentic crystals.",
          "url": url,
    ...
    let hreflang = document.querySelector('link[rel="alternate"][hreflang="en-CA"]');
    if (!hreflang) {
