...
import { Gem, Heart, Star, Sparkles, Moon, Sun, Compass, Zap } from "lucide-react";
  ...
  const values = [
    {
      ...
      description: "Every piece features genuine, ethically sourced crystals selected for their unique energy and healing properties.",
      color: "troves-turquoise"
    },
    {
      icon: Heart,
      title: "Sacred Craftsmanship",
      description: "Hand-wrapped with intention and love, each piece is created to channel positive energy and spiritual connection.",
      color: "coves-cursive-blue"
    },
    {
      icon: Star,
      title: "Mystical Design",
      description: "Our designs blend ancient wisdom with modern aesthetics, creating wearable art that speaks to the soul.",
      color: "skull-turquoise"
    },
    {
      icon: Moon,
      title: "Spiritual Guidance",
      description: "We provide personalized consultations to help you find the perfect crystal companions for your journey.",
      color: "troves-turquoise"
    }
  ];
  ...
  const story = [
    {
      ...
      description: "Born from a deep connection to crystal energy and ancient wisdom, Troves & Coves emerged as a sacred space for spiritual seekers.",
      icon: Compass,
      color: "coves-cursive-blue"
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-stone-warm via-pearl-cream to-moonstone">
      ...
      <section className="relative bg-gradient-to-br from-pearl-cream via-crystal-accents to-pearl-cream text-navy overflow-hidden py-20">
        ...
        <div className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-coves-cursive-blue to-transparent" />
        ...
        <div className="relative container mx-auto px-4 text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-bold mb-6" style={{ fontFamily: 'var(--brand-font-heading)' }}>
            ...
            <span className="text-coves-cursive-blue" style={{ fontFamily: 'var(--brand-font-cursive)' }}>Troves & Coves</span>
          </h1>
      ...
      <div className="container mx-auto px-4 py-16">
          ...
          <Card className="shadow-2xl border border-ornate-frame-gold/20 bg-gradient-to-br from-pearl-cream to-crystal-accents backdrop-blur-sm">
            <CardContent className="p-12 text-center">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <Badge variant="outline" className="border-troves-turquoise text-troves-turquoise bg-troves-turquoise/5 px-4 py-2">
                  Handcrafted with Love
                </Badge>
                <Badge variant="outline" className="border-coves-cursive-blue text-coves-cursive-blue bg-coves-cursive-blue/5 px-4 py-2">
                  Ethically Sourced
                </Badge>
                <Badge variant="outline" className="border-skull-turquoise text-skull-turquoise bg-skull-turquoise/5 px-4 py-2">
                  Spiritually Infused
                </Badge>
              </div>
            </CardContent>
        ...
        <section className="mb-20">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-navy mb-4">Our Sacred Journey</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {story.map((chapter, index) => {
              ...
              return (
                <Card key={index} className="shadow-2xl border border-ornate-frame-gold/20 bg-gradient-to-br from-pearl-cream to-crystal-accents backdrop-blur-sm group hover:scale-105 transition-all duration-300">
                  <CardHeader className={`bg-gradient-to-r from-${chapter.color}/10 to-${chapter.color}/5 border-b border-ornate-frame-gold/20`}>
                    <div className="flex items-center space-x-4">
                      <div className={`w-12 h-12 bg-${chapter.color} rounded-full flex items-center justify-center`}>
                        <Icon className="w-6 h-6 text-white" />
                      </div>
                      <div>
                        <Badge variant="outline" className={`border-${chapter.color} text-${chapter.color} mb-2`}>
                          {chapter.phase}
                        </Badge>
                        <CardTitle className="text-navy text-xl">{chapter.title}</CardTitle>
                      </div>
                    </div>
                  </CardHeader>
                  <CardContent className="p-6">
                    <p className="text-navy/80 leading-relaxed">{chapter.description}</p>
                  </CardContent>
                </Card>
              );
            })}
        ...
        <section className="mb-20">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-navy mb-4">Our Sacred Values</h2>
            ...
            <p className="text-navy/70 text-lg mt-6 max-w-3xl mx-auto">
              These core values guide every aspect of our craft, from crystal selection to the final blessing of each piece.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value, index) => {
              ...
              return (
                <Card key={index} className="shadow-2xl border border-ornate-frame-gold/20 bg-gradient-to-br from-pearl-cream to-crystal-accents backdrop-blur-sm text-center group hover:scale-105 transition-all duration-300">
                  <CardContent className="p-6">
                    <div className={`w-16 h-16 bg-${value.color} rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300`}>
          ...
          <Card className="shadow-2xl border border-ornate-frame-gold/20 bg-gradient-to-br from-pearl-cream to-crystal-accents backdrop-blur-sm">
            <CardHeader className="bg-gradient-to-r from-troves-turquoise/10 via-skull-turquoise/10 to-coves-cursive-blue/10 border-b border-ornate-frame-gold/20">
              <CardTitle className="text-center">
                <div className="flex items-center justify-center space-x-3 text-navy">
                  ...
                  <span className="text-3xl font-bold">Our Sacred Craft</span>
            ...
            <CardContent className="p-12">
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                  <h3 className="text-2xl font-bold text-navy mb-6">Hand-Wrapped with Intention</h3>
                  <div className="space-y-6">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h4 className="font-semibold text-navy mb-2">Crystal Selection</h4>
                        <p className="text-navy/70">Each crystal is hand-selected for its energy, clarity, and spiritual properties.</p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h4 className="font-semibold text-navy mb-2">Sacred Wrapping</h4>
                        <p className="text-navy/70">Wire is carefully wrapped with meditation and positive intention.</p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h4 className="font-semibold text-navy mb-2">Energy Blessing</h4>
                        <p className="text-navy/70">Each finished piece receives a blessing to activate its healing potential.</p>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <section className="mb-20">
          <Card className="shadow-2xl border border-ornate-frame-gold/20 bg-gradient-to-br from-pearl-cream to-crystal-accents backdrop-blur-sm">
            <CardContent className="p-12 text-center">
              <div className="mb-8">
                <h2 className="text-3xl font-bold text-navy mb-6">Join Our Sacred Community</h2>
              ...
              <p className="text-navy/80 text-lg leading-relaxed max-w-4xl mx-auto mb-8">
                Troves & Coves is more than a jewelry brand—we're a community of spiritual seekers, crystal lovers, and conscious souls. 
                When you wear our pieces, you join a worldwide network of light workers and healers, each carrying the sacred energy of authentic crystals.
              </p>
              <div className="grid md:grid-cols-3 gap-8 mt-12">
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-bold text-navy mb-2">Daily Inspiration</h3>
                  <p className="text-navy/70">Crystal wisdom and spiritual guidance shared through our community.</p>
                </div>
                <div className="text-center">
                  <div className="w-20 h-20 bg-coves-cursive-blue rounded-full flex items-center justify-center mx-auto mb-4">
                    <Moon className="w-10 h-10 text-white" />
                  </div>
                  <h3 className="text-xl font-bold text-navy mb-2">Sacred Rituals</h3>
                  <p className="text-navy/70">Learn how to cleanse, charge, and work with your crystal jewelry.</p>
                </div>
                <div className="text-center">
                  <div className="w-20 h-20 bg-skull-turquoise rounded-full flex items-center justify-center mx-auto mb-4">
                    <Star className="w-10 h-10 text-white" />
                  </div>
                  <h3 className="text-xl font-bold text-navy mb-2">Healing Circle</h3>
                  <p className="text-navy/70">Connect with like-minded souls on their spiritual journey.</p>
                </div>
              </div>
            </CardContent>
          </Card>
