...
import { CreditCard, Calendar, DollarSign, Shield, Calculator, CheckCircle } from "lucide-react";
  ...
  const paymentOptions = [
    {
      ...
      benefits: ["No interest or fees", "Instant approval", "Easy checkout integration"]
    },
    {
      ...
      benefits: ["No interest if paid on time", "No impact on credit score", "Flexible payment dates"]
    },
    {
      ...
      benefits: ["Buyer protection included", "Secure payment processing", "Multiple payment methods"]
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-stone-warm via-pearl-cream to-moonstone">
      ...
      <section className="relative bg-gradient-to-br from-pearl-cream via-crystal-accents to-pearl-cream text-navy overflow-hidden py-20">
        ...
        <div className="relative container mx-auto px-4 text-center">
          ...
          <p className="text-navy/80 text-xl max-w-3xl mx-auto leading-relaxed">
            Make your sacred crystal jewelry more accessible with flexible payment options. Invest in your spiritual journey without compromising your budget.
          </p>
        </div>
      </section>
      ...
      <div className="container mx-auto px-4 py-12">
        {/* Payment Options */}
        <div className="mb-12">
          <h2 className="text-3xl font-bold text-navy mb-8 text-center">Payment Plans Available</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {paymentOptions.map((option) => {
              const Icon = option.icon;
              return (
                <Card key={option.name} className="shadow-2xl border border-ornate-frame-gold/20 bg-gradient-to-br from-pearl-cream to-crystal-accents backdrop-blur-sm">
                  ...
                  <CardContent className="p-6">
                    ...
                    <ul className="space-y-2">
                      {option.benefits.map((benefit, index) => (
                        <li key={index} className="text-navy/70 text-sm flex items-start space-x-2">
          ...
          <CardContent className="p-6">
            <div className="grid md:grid-cols-4 gap-6">
              <div className="text-center">
                ...
                <p className="text-navy/70 text-sm">Add your favorite crystal jewelry to cart</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-troves-turquoise/20 rounded-full flex items-center justify-center mx-auto mb-3">
                ...
                <p className="text-navy/70 text-sm">Select your preferred payment option at checkout</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-troves-turquoise/20 rounded-full flex items-center justify-center mx-auto mb-3">
                ...
                <p className="text-navy/70 text-sm">Instant approval decision in seconds</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-troves-turquoise/20 rounded-full flex items-center justify-center mx-auto mb-3">
                ...
                <p className="text-navy/70 text-sm">Receive your jewelry immediately</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <Card className="shadow-2xl border border-ornate-frame-gold/20 bg-gradient-to-br from-pearl-cream to-crystal-accents backdrop-blur-sm">
            <CardHeader className="bg-gradient-to-r from-troves-turquoise/10 to-skull-turquoise/10 border-b border-ornate-frame-gold/20">
              <CardTitle className="flex items-center space-x-3 text-troves-turquoise">
                ...
                <span className="font-bold text-xl">Eligibility Requirements</span>
              </CardTitle>
            </CardHeader>
            <CardContent className="p-6">
          ...
          <Card className="shadow-2xl border border-ornate-frame-gold/20 bg-gradient-to-br from-pearl-cream to-crystal-accents backdrop-blur-sm">
            ...
            <CardContent className="p-6">
              <div className="bg-skull-turquoise/10 rounded-lg p-4 border border-ornate-frame-gold/20">
                <h4 className="font-semibold text-navy mb-3">$200 Crystal Necklace</h4>
                <div className="space-y-2 text-sm">
                  ...
                  <div className="border-t border-ornate-frame-gold/20 pt-2 mt-2">
                    ...
                    <p className="text-xs text-green-600 mt-1">No interest or fees!</p>
                  </div>
                </div>
              </div>
            </CardContent>
        ...
        <Card className="shadow-2xl border border-ornate-frame-gold/20 bg-gradient-to-br from-pearl-cream to-crystal-accents backdrop-blur-sm">
          <CardContent className="p-8 text-center">
            ...
            <h3 className="text-2xl font-bold text-navy mb-4">Start Your Crystal Journey Today</h3>
            <p className="text-navy/80 mb-6 max-w-2xl mx-auto">
              Don't let budget constraints delay your spiritual growth. Our flexible payment plans make it easy to invest 
              in authentic crystal jewelry that will support your healing journey for years to come.
            </p>
