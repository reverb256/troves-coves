  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-stone-warm via-pearl-cream to-moonstone">
      ...
      <section className="relative bg-gradient-to-br from-pearl-cream via-crystal-accents to-pearl-cream text-navy overflow-hidden py-20">
        ...
        <div className="relative container mx-auto px-4 text-center">
          ...
          <p className="text-navy/80 text-xl max-w-3xl mx-auto leading-relaxed">
            Your sacred crystal jewelry is protected by our comprehensive warranty, ensuring lasting quality and spiritual integrity for your healing journey.
          </p>
        </div>
      </section>
      ...
      <div className="container mx-auto px-4 py-12">
        {/* Warranty Coverage */}
        <div className="mb-12">
          <h2 className="text-3xl font-bold text-navy mb-8 text-center">Warranty Coverage</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {warrantyTerms.map((term) => {
              const Icon = term.icon;
              return (
                <Card key={term.category} className="shadow-2xl border border-ornate-frame-gold/20 bg-gradient-to-br from-pearl-cream to-crystal-accents backdrop-blur-sm">
          ...
          <CardContent className="p-6">
            <div className="grid md:grid-cols-4 gap-6">
              <div className="text-center">
                ...
                <p className="text-navy/70 text-sm">Email us with photos and your order details</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-troves-turquoise/20 rounded-full flex items-center justify-center mx-auto mb-3">
                ...
                <p className="text-navy/70 text-sm">We review your claim within 24 hours</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-troves-turquoise/20 rounded-full flex items-center justify-center mx-auto mb-3">
                ...
                <p className="text-navy/70 text-sm">Ship your item using our prepaid label</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-troves-turquoise/20 rounded-full flex items-center justify-center mx-auto mb-3">
                ...
                <p className="text-navy/70 text-sm">Repair or replacement within 5-7 days</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="shadow-2xl border border-ornate-frame-gold/20 bg-gradient-to-br from-pearl-cream to-crystal-accents backdrop-blur-sm">
          <CardContent className="p-8 text-center">
            ...
            <h3 className="text-2xl font-bold text-navy mb-4">Our Sacred Promise</h3>
            <p className="text-navy/80 mb-6 max-w-2xl mx-auto">
              Every piece of Troves & Coves jewelry carries our sacred commitment to quality, authenticity, and spiritual integrity. 
              Beyond our formal warranty, we stand behind the energy and craftsmanship of each creation on your healing journey.
            </p>
